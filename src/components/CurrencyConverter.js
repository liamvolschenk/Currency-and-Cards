...
//API that contains all the exchange rates
const BASE_URL = 'https://v6.exchangerate-api.com/v6/ba701dec95c5352b5df96b50/latest/USD';

//setting the state for the necessary variables
...
//the algorithm to calculate the exchange rates    
...
//fetching the API information and adding it to the state
    useEffect(() => {
        fetch(BASE_URL)
            .then(res => res.json())
            .then(data => {
...
//injecting the data to the input fields    
    return (
        <>
